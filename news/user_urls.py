...
urlpatterns = [
    ...
    path("about-stats/", user_views.AboutStatsView.as_view(), name="user-about-stats"),
    path("articles/batch/", user_views.ArticleBatchView.as_view(), name="user-articles-batch"),
