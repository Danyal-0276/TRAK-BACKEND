...
urlpatterns = [
    ...
    path("scrape/run/", api_views.AdminScrapeRunView.as_view(), name="admin-scrape-run"),
    path("scrape-and-pipeline/run/", api_views.AdminScrapeAndPipelineRunView.as_view(), name="admin-scrape-and-pipeline-run"),
